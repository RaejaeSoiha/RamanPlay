...
export default function UfcFighterDetail({ fighterId }: { fighterId: string }) {
  ...
  if (!fighter) return <div className="empty">Loading fighter…</div>;
  function toggle() {
